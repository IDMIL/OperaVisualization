...
export const text = {
    'en' : {
        ...
        BYLINE: '<p>Inform Performance and Creation Through Analysis, a research project funded by the Social Sciences and Humanities Research Council of Canada (SSHRC), Connexion Grant (November 2025–October 2026)</p>\n' +
    ...
    'pt' : {
        ...
        BYLINE: '<p>Informar a interpretação e a criação através da análise, projeto de investigação financiado pelo Conselho de Investigação em Ciências Humanas do Canadá (CRSH), Bolsa Connexion (novembro de 2025-outubro de 2026)</p>\n' +
    ...
    'de' : {
        ...
        BYLINE: '<p>Interpretation und Schöpfung durch Analyse – ein vom Social Sciences and Humanities Research Council of Canada (SSHRC) gefördertes Forschungsprojekt, Connexion-Förderung (November 2025–Oktober 2026)</p>\n' +
    ...
    'fr' : {
        ...
        BYLINE: '<p>Informer l’interprétation et la création par l’analyse, projet de recherche subventionné par le Conseil de recherches en sciences humaines du Canada (CRSH), Subvention Connexion (novembre 2025-octobre 2026)</p>\n' +
